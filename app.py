...
#st.session_state.interview_history = [
    #{
        ...
        #"answer": "I am a master's student."
    #}
#]
...
# -------------------------------------------------
    ...
    """)
        ...
        st.subheader("📌 Question Relevance")

        q1 = st.radio(
            "1. The interview questions were relevant to the selected job position.",
            [1, 2, 3, 4, 5],
            index=None,
            horizontal=True
        )
        ...
        q2 = st.radio(
            "2. The adaptive follow-up questions were relevant to my responses.",
            [1, 2, 3, 4, 5],
            index=None,
            horizontal=True
        )
        ...
        q3 = st.radio(
            "3. The AI assessment accurately reflected my interview performance.",
            [1, 2, 3, 4, 5],
            index=None,
            horizontal=True
        )
        ...
        q4 = st.radio(
            "4. The feedback generated by the AI was useful.",
            [1, 2, 3, 4, 5],
            index=None,
            horizontal=True
        )
        ...
        q5 = st.radio(
            "5. The AI interview system was easy to use.",
            [1, 2, 3, 4, 5],
            index=None,
            horizontal=True
        )
        ...
        q6 = st.radio(
            "6. The interview process felt natural and engaging.",
            [1, 2, 3, 4, 5],
            index=None,
            horizontal=True
        )
        ...
        q7 = st.radio(
            "7. I would use this AI interview system again for interview preparation.",
            [1, 2, 3, 4, 5],
            index=None,
            horizontal=True
        )
        ...
        q8 = st.radio(
            "8. Overall, I am satisfied with this AI interview system.",
            [1, 2, 3, 4, 5],
            index=None,
            horizontal=True
        )
        ...
        st.success("✅ Interview and Feedback Submitted Successfully!")
        ...
        Your interview responses and feedback have been successfully submitted.
